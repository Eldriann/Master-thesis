""" Beam Search module 
    Majority of code borrowed from https://github.com/OpenNMT/OpenNMT-py
"""

import torch

from abstractive.decode_strategy import DecodeStrategy
        ...
        for i in range(self.is_finished.size(0)):
            ...
            for j in finished_hyp:
                ...
                self.hypotheses[b].append((
                    ...
                    attention[:, i, j, :] 
                    if attention is not None else None))  ## changed this from original code
